...
import { BookOpen, Clock, User, Play, Check } from "lucide-react";
          ...
          <div className="relative aspect-[3/4] bg-gradient-to-br from-primary/10 via-primary/5 to-primary/10 overflow-hidden shrink-0">
            ...
            {(hasProgress || isFinished) && (
              <div className="absolute top-3 right-3">
                <div className={`flex items-center gap-1.5 rounded-full pl-1.5 pr-2.5 py-1 shadow-sm backdrop-blur-md border ${isFinished ? "bg-success/90 border-success/20" : "bg-background/90 border-border/60"}`}>
                  {isFinished ? (
                  ...
                  <span className={`text-[10px] font-semibold ${isFinished ? "text-white" : "text-foreground"}`}>
